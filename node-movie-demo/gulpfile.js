...
var gulp = require('gulp'),
    ...
    plugins = require('gulp-load-plugins')();//引入依赖插件
...
gulp.task('images', function() {
  return gulp.src(path.src.images)
    .pipe(plugins.cache(plugins.imagemin({ progressive: true, interlaced: true })))//gulp-imagemin: 压缩图片
...
gulp.task('nodemon',function() {
  plugins.nodemon({ script: 'bin/www',
